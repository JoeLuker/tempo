...
def mock_generator_components():
    ...
    mock_generator.generate.return_value = {
        ...
        "all_pruned_token_sets": {0: [(101, 0.9)]},
...
class TestAPI:
    ...
    def test_generate_with_pruning_error(self, client, mock_generator_components):
        """Test error handling when retroactive pruning initialization fails."""
        mock_model, mock_tokenizer, mock_generator = mock_generator_components
        ...
        assert "Failed to initialize retroactive pruning" in response.json()["detail"]
