...
class TEMPOModelWrapper(nn.Module):
        ...
        def hook(module, inputs, outputs):
            ...
            if self.debug_mode:
                if isinstance(outputs, tuple):
                    shapes = [o.shape if hasattr(o, "shape") else "N/A" for o in outputs]
    ...
    def forward(self, *args, **kwargs):
        """
        Forward pass that captures intermediate values.
        All arguments are passed directly to the wrapped model.
        
        Returns:
            The same output as the wrapped model, with intermediate_values added
        """
        ...
        # Add intermediate values as an attribute of the outputs
        if hasattr(outputs, "__dict__"):
            outputs.intermediate_values = self.intermediate_values
