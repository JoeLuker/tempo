...
def mock_model_singleton():
    ...
    mock_generator.generate.return_value = {
        ...
        "token_sets": [
            (0, (torch.tensor([101, 2023]), torch.tensor([0.9, 0.8])), (torch.tensor([101]), torch.tensor([0.9])))
        ],
        "generation_time": 0.5,
        "pruning_time": 0.1,
        "is_qwen_model": False,
    ...
    ModelSingleton.get_instance = MagicMock(return_value=(mock_model, mock_tokenizer, mock_generator))
