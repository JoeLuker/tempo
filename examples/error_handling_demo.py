...
from src.utils.error_manager import (
    ...
    ModelError, TokenizationError, GenerationError, 
    ConfigurationError, ResourceError, safe_execute
)
from src.utils.exception_handlers import (
    handle_exceptions, handle_model_errors, handle_tokenization_errors,
    handle_generation_errors, retry, exception_context
)
...
def main():
    ...
    try:
        ...
        logger.info("Logger metrics report:", 
