...
def main():
    ...
    print("\n# Standard generation with prompt from file:")
    print("python run_generate.py --standard-generation --prompt-file \"your_prompt.txt\"")
    print("\n# Parallel generation without custom attention:")
    print("python run_generate.py --prompt \"Your prompt here\" --threshold 0.05")
    print("\n# Parallel generation with prompt from file:")
    print("python run_generate.py --prompt-file \"your_prompt.txt\" --threshold 0.05")
